...
Guided Autoencoder with Transformer(GAET) to compute a **Senescence-Associated Secretory Phenotype (SASP) score** from a panel of 38 protein markers. This repository includes:

- A PyTorch model (`GAET`) for encoding protein profiles and predicting a scalar SASP score
...
├── proteins_info.py        # Protein list, data cleaning helpers
